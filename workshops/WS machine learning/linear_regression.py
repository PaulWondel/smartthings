...
x = [46, 20, 52, 30, 57, 25, 28, 36, 57, 44, 24, 31, 52, 23, 60, \
     48, 34, 51, 50, 34, 46, 23, 37, 40, 30]
...
print(network.inference([40, 1]))
plot.plot(*zip(*lossGraph))
plot.show()
plot.clf()
plot.scatter(x, y)
line = [network.links[0].weight * i + network.links[1].weight for i in x]
plot.plot(x, line)
plot.show()
